                    ...
                    <div class="zm-posts">
                        ...
                        <article class="zm-post-lay-e zm-single-post clearfix">
                                <div class="zm-post-thumb f-left">
                                    <a href="blog-single-image.html" style="height:70px;background: url('{{$news->image}}') no-repeat;
                                ...
                                <div class="zm-post-dis f-right">
                                    <div class="zm-post-header">
                                        <h2 class="zm-post-title"><a href="blog-single-image.html">{{$news->header}}</a></h2>

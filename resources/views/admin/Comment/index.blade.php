...
<div class="quick-actions_homepage">
        ...
        <li class="bg_ls span3"> <a href="{{route('dailycomment')}}"><i class="icon-tint"></i> Bu Günün Şərhləri</a> </li>

        <li class="bg_lg span3"> <a href="{{route('checkedcomment')}}"> <i class="icon-check"></i> Təsdiqlənmiş Şərhlər</a> </li> 
          <li class="bg_lr"> <a href="{{route('notcheckcomment')}}"> <i class="icon-remove"></i> Təsdiqlənməmiş Şərhlər</a> </li>
          <li class="bg_lb"> <a href="{{route('replycomment')}}"> <i class="icon-th-list"></i> Cavablandırılmış Şərhlər</a> </li>
